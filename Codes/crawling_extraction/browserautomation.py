...
def main(file_urls, num_instances, net_interface, output_folder):
    with open(file_urls, 'r') as c:
      ...
      path_to_log_folder = "/home/khan/Desktop/website_fingerprinting_proxy-stable/workspace/logs/"
      ...
      for url in c_contents:
        if count < 22:
          ...
          for link_in_path in links_list:
            ...
            identifier += 1
        count += 1
      q = subprocess.Popen(('sudo', 'chown', '-R', 'khan', '/home/khan/Desktop/website_fingerprinting_proxy-stable/workspace/pcap_files'), stdout=subprocess.PIPE, preexec_fn=os.setsid)
